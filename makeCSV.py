...
energyframe = read_csv('data/2015-2016.csv').append(read_csv('data/2016-2017.csv')).append(read_csv('data/2017-2018.csv')).append(read_csv('data/2018-2019.csv'))
...
priceframe = read_csv('data/prices2015-2016.csv').append(read_csv('data/prices2016-2017.csv')).append(read_csv('data/prices2017-2018.csv')).append(read_csv('data/prices2018-2019.csv'))
...
dataset.to_csv("data/joined_data_2015-2019.csv")
